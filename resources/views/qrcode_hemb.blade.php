                ...
                <div class="col-md-9">
                    <div class="patient-info">
                        ...
                        <ul>
                            ...
                            <li><strong>Date of Training:</strong> {{ $qrcode->date_training }}</li>
                            <li><strong>Date of Expiration:</strong> {{ $qrcode->date_expiry }}</li>
                            <li><strong>Institution:</strong> {{ $qrcode->institution }}</li>
                        </ul>
                    </div>
                </div>
            </div>
