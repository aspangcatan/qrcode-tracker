...
<div class="container">
    ...
    <table style="width: 100%;margin-top:15px">
        <tr>
            ...
            <td style="width: 10%"><div style="margin-left: 5px;">of</div></td>
        </tr>
    </table>
    <table style="width: 100%;margin-top:15px">
        <tr>
            <td class="border-bottom text-center" style="width: 53%">SAN ISIDRO, TALISAY CITY, CEBU</td>
            <td class="border-bottom text-center" style="width: 15%">, 32 years old</td>
            <td class="border-bottom text-center" style="width: 15%">, MALE</td>
            <td style="width: 10%"><div style="margin-left: 5px;">, was</div></td>
        </tr>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td class="border-bottom text-center" style="width: 25%">OCTOBER 08, 2023 .</td>
        </tr>
        <tr class="text-center">
            <td></td>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td class="border-bottom text-center" style="width: 49%">DR. JAMES C. BERNAL</td>
            <td style="width: 2%">-</td>
