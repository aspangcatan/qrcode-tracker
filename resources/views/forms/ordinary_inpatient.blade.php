                    ...
                    <div class="medium">
                        <select class="js-example-basic-single w-100"  id="received_by" class="w-100 text-center">
                            ...
                            @if(isset($certificates) && $certificates)
                                ...
                                <option {{ $certificates->received_by === "Shaira Joyce C. Abangan" ? 'selected' : '' }}>Shaira Joyce C. Abangan</option>
                                ...
                                <option {{ $certificates->received_by === "Aiza Marie M. Francisco" ? 'selected' : '' }}>Aiza Marie M. Francisco</option>
                            @else
